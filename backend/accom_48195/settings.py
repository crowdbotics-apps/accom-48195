"""
Django settings for accom_48195 project.
...
WSGI_APPLICATION = 'accom_48195.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "accom_48195 API",
    "DESCRIPTION": "API documentation for accom_48195 App",
    "VERSION": "v1",
}
